...
const ClinicList = (props) => {
  ...
  const renderLoadingSpinner = useCallback(() => (
    <div role="status" className="w-full flex flex-col justify-center items-center">
      <svg className="inline mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-200 fill-purple-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <span className="text-purple-600">Loading clinic data...</span>
    </div>
  ), []);

  const renderClinicList = useCallback(() => (
    <>
